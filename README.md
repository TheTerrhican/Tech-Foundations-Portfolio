...
* **AWS Cloud Essentials** | In Progress (Targeting AWS Solutions Architect - Associate)
...
The projects below demonstrate practical application of my certified skills. Each entry includes detailed documentation (the "Case Study" or "README") explaining the problem, the solution, the technical architecture, and the technologies used.
